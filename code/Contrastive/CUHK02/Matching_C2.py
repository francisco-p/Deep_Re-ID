...
x_val = x[6460:]
labels_val = labels[6460:]
x_train = x[:6460]
labels_train = labels[:6460]
...
callbacks = ModelCheckpoint('/home/fproenca/Tese/Results/CUHK02/final_test_match.h5', monitor='val_loss', verbose=2, save_best_only=True, save_weights_only=True, mode='auto')
