...
x_val = x[11763:]
labels_val = labels[11763:]
x_train = x[:11763]
labels_train = labels[:11763]
...
model = load_model('/home/fproenca/Tese/Results/Market/MobileNet_Class_224.h5')
model.summary()
...
for layer in embedding_network.layers:
  if layer.name == "Embedding":
    for i in layer.layers:
      print(i.name)
      i.trainable = False
#embedding_network.add((Dense(1024, activation='relu',name="1024")))
#embedding_network.add(BatchNormalization())
#embedding_network.add((Dense(512, activation='relu',name="512")))
#embedding_network.add(BatchNormalization())
#embedding_network.add((Dense(256, activation='relu',name="256_")))
#embedding_network.add(BatchNormalization())
#embedding_network.add((Dense(256, activation='relu',name="128")))
...
callbacks = ModelCheckpoint('/home/fproenca/Tese/Results/Market/final_test_match.h5', monitor='val_loss', verbose=2, save_best_only=True, save_weights_only=True, mode='auto')
