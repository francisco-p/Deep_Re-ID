...
def make_triplets1(images, labels,flag):
...
triplet_val, val_loss = make_triplets1(x_val, labels_val,1)



pickle_out = open("/home/fproenca/Tese/Data/Market/triplet_val.pickle","wb")
pickle.dump(triplet_val, pickle_out)
pickle_out.close()


pickle_out = open("/home/fproenca/Tese/Data/Market/val_loss.pickle","wb")
