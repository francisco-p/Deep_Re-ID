...
def base_model():
    ...
    model.add(Dense(1717, activation='softmax'))
...
labels = to_categorical(labels, num_classes=1717)
...
callbacks = ModelCheckpoint('/home/fproenca/Tese/Results/CUHK02/MobileNet_Class_224.h5', monitor='val_loss', verbose=2, save_best_only=True, save_weights_only=False, mode='auto')
