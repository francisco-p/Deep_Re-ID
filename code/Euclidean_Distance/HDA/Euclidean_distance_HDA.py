...
labels_train = to_categorical(labels_train, num_classes=33)
labels_valid = to_categorical(labels_valid, num_classes=33)
...
callbacks = ModelCheckpoint('/home/fproenca/Tese/Results/HDA/MobileNet_Class_224.h5', monitor='val_loss', verbose=2, save_best_only=True, save_weights_only=False, mode='auto')
